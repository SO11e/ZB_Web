    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="box box-default">
            <div class="box-header">
                ...
                <div class="box-tools">
                    <a href="{{ route('issue.list') }}" class="btn btn-warning btn-xs"><i class="fa fa-plus"></i> Nieuwe rapportage</a>
                </div>
            </div>
                ...
                <table id="reports-table" class="table table-striped">
                    ...
                    @foreach($reports as $report)
                        <tr>
                            ...
                            <td>{{ $report->createdBy != null ? $report->createdBy->fullname : 'Onbekend'}}</td>
                            <td>{{ $report->issues != null ? count($report->issues) : '0' }}</td>
                            <td>
                                <div class="btn-group btn-group-xs" width="100%">
                                    <a href="{{ route('report.view', $report->id) }}" class="btn btn-warning btn-xs"><i class="fa fa-arrow-circle-o-right"></i> Bekijken</a>
