                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <span><i class="fa fa-user"></i> {{ $userdata->firstname != '' && $userdata->lastname != '' ? $userdata->firstname . ' ' . $userdata->lastname : 'Onbekende gebruiker' }}</span></a>
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        <img src="{{ asset('/resources/dist/img/user.png') }}" class="img-circle" alt="User Image">
                                        <p>{{ $userdata->firstname != '' && $userdata->lastname != '' ? $userdata->firstname . ' ' . $userdata->lastname : 'Onbekende gebruiker' }}
                                            <small>{{ $userdata->region->name != '' ? $userdata->region->name : 'Onbekende regio' }}</small>
                                        </p>
                                    </li>
